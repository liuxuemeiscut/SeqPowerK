...
namespace CalDistance
{
    class Dissimiliraty
    {
        ...
        {
            if (result.ContiansKeys("Eu_k" + k) || result.ContiansKeys("Ma_k" + k) || result.ContiansKeys("Ch_k" + k) || result.ContiansKeys("D2_k" + k))
            {
                return;
            }
            //Eu
        ...
        {
            result.SaveResult(key, seqX.ID, seqY.ID, value);
        }
    }
}
